...
#fig1 = plt.figure()
#ax1 = plt.gca()
#ax1.plot(index, pca.explained_variance_ratio_,'o-', color="r", label="Magnitude of j-th largest eigenvalue")
#ax1.legend(loc="best")
#ax1.set_yscale('log')
...
#fig2 = plt.figure()
#ax2 = plt.gca()
#ax2.plot(index, pca.explained_variance_ratio_,'o-', color="r", label="Magnitude of j-th largest eigenvalue")
#ax2.legend(loc="best")
#plt.xlabel('jth largest eigenvalue')
#plt.ylabel('Magnitude')
...
df.to_csv("dataset/good_PCA36.csv", index=False)
print("good_PCA36.csv saved with shape: ",np.shape(dataPCA))
